...
@interface NSArray (SWIFT_EXTENSION(EasyconnTalkie))
@end
...
@interface NSNull (SWIFT_EXTENSION(EasyconnTalkie))
@end


@interface NSString (SWIFT_EXTENSION(EasyconnTalkie))
@end


SWIFT_CLASS("_TtC14EasyconnTalkie13OnAckCallback")
